...
(function () {
  ...
  const myQuestions = [
    ...
    {
      question: "Maximum permissible limit of peroxide value in a fat/oil is ",  ///// Write the question inside double quotes
      answers: {
        a: "< 10 meq/kg of sample",                  ///// Write the option 1 inside double quotes
        b: "< 20 meq/kg of sample",                  ///// Write the option 2 inside double quotes
        c: "< 30 meq/kg of sample",                  ///// Write the option 3 inside double quotes
        d: "< 40 meq/g of sample"                   ///// Write the option 4 inside double quotes
      },
      correctAnswer: "a"                ///// Write the correct option inside double quotes
    },                                  ///// To add more questions, copy the section below 

    {
      question: "Iodine gives……………..color with starch",  ///// Write the question inside double quotes
      answers: {
        a: "Orange",                  ///// Write the option 1 inside double quotes
        b: "Purple",                  ///// Write the option 2 inside double quotes
        c: "Red",                  ///// Write the option 3 inside double quotes
        d: "Blue"                   ///// Write the option 4 inside double quotes
      },
      correctAnswer: "d"                ///// Write the correct option inside double quotes
    },                                  ///// To add more questions, copy the section below 

    {
      question: "Which indicator is used in determination of oxidative rancidity of fats/oils  ",  ///// Write the question inside double quotes
      answers: {
        a: "Phenolphthalein",                  ///// Write the option 1 inside double quotes
        b: "Starch",                  ///// Write the option 2 inside double quotes
        c: "Methylene blue",                  ///// Write the option 3 inside double quotes
        d: "NaOH"                   ///// Write the option 4 inside double quotes
      },
